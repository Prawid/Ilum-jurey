    ...
    <div class="row">
      <div class="col-md-5">
        <div class="project-info-box mt-0">
          <h5><?php echo $d['Nama_peker'] ?></h5>

        </div><!-- / project-info-box -->


        <div class="project-info-box">
          <p><b>Nama Pekerjaan:</b> <?php echo $d['Nama_peker'] ?></p>

        </div><!-- / project-info-box -->
        <div class="project-info-box">
          <b>Persyaratan</b>
          <p><?php echo $d['syarat'] ?></p>
        </div><!-- / project-info-box -->

        <div class="project-info-box">
          <b>Job Desk</b>
          <p><?php echo $d['jobdesk'] ?></p>
        </div><!-- / project-info-box -->

        <a class="btn btn-primary" href="formloker.php">Lamar</a>
      </div><!-- / column -->
