    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <h1 class="h3 mb-2 text-gray-800">Form Tambah Data Produk</h1>
          <form method="post" action="" enctype="multipart/form-data">
            <div class="row mb-3">
              <label class="col-sm-2 col-form-label">ID_Produk</label>
              <div class="col-sm-10">
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
          ...
          if (!in_array($gambar, $tipe_diizinkan)) {
            ...
            $insert = mysqli_query($sambungin, "INSERT INTO produk VALUES(
                                      '$ID_Produk',
                                      '$Nama_Produk',
                                      '$Deskripsi_Produk',
                                      '$newname1')");
