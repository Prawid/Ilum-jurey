    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          $data = mysqli_query($sambungin, "SELECT * FROM produk WHERE ID_Produk='$ID_Produk'");
          ...
          ?>
            <form method="post" action="" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="Nama_Produk" value="<?php echo $d['Nama_Produk']; ?>">
                </div>
              </div>
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label">Deskripsi Produk</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="Deskripsi_Produk" value="<?php echo $d['Deskripsi_Produk']; ?>">
                </div>
              </div>
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
          ...
          if (!in_array($gambar, $tipe_diizinkan)) {
            ...
            $insert = mysqli_query($sambungin, "UPDATE produk SET 
                                      
                                      Nama_Produk='$Nama_Produk',
                                      Deskripsi_Produk='$Deskripsi_Produk',
                                      gambar='$newname1' WHERE ID_Produk='$ID_Produk'");
            if ($insert) {
