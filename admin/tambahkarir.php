      ...
      <div id="content">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item" href="editadmin.php?nip=<?php echo $_SESSION['ID_Admin'] ?>">
        ...
        <div class="container-fluid">
          ...
          <form method="post" action="" enctype="multipart/form-data">
            <div class="row mb-3">
              <label class="col-sm-2 col-form-label">ID_loker</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="ID_loker">
              </div>
            </div>
            <div class="row mb-3">
              <label class="col-sm-2 col-form-label">Nama Pekerjaan</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="Nama_peker">
              </div>
            </div>
            <div class="row mb-3">
              <label class="col-sm-2 col-form-label">Persyaratan</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="syarat">
              </div>
            </div>
            <div class="row mb-3">
            ...
            <button class="btn btn-primary">Tambahkan Karir</button>
          </form>
        </div>
        <?php
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
          ...
          if (!in_array($gambar, $tipe_diizinkan)) {
            ...
            $insert = mysqli_query($sambungin, "INSERT INTO karir VALUES(
                                      '$ID_loker',
                                      '$Nama_peker',
                                      '$syarat',
                                      '$jobdesk',
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; PT ILUM JOREY PERSADA 2022</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
