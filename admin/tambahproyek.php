...
<head>
  ...
  <title>PT ILUM JOREY ADMIN Admin</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <h1 class="h3 mb-2 text-gray-800">Form Tambah Data Proyek</h1>
          <form method="post" action="" enctype="multipart/form-data">
            <div class="row mb-3">
              <label class="col-sm-2 col-form-label">ID_Proyek</label>
              <div class="col-sm-10">
                <input type="text" class="form-control" name="ID_Proyek">
              </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="Deskripsi_Proyek">
              </div>
            </div>
            ...
            <button class="btn btn-primary">Tambahkan Proyek</button>
          </form>
        </div>
        <?php
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
          ...
          if (!in_array($gambar, $tipe_diizinkan)) {
            ...
            $insert = mysqli_query($sambungin, "INSERT INTO proyek VALUES(
                                      '$ID_Proyek',
                                      '$Nama_Proyek',
                                      '$Deskripsi_Proyek',
                                      '$newname1')");
