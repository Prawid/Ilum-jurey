      ...
      <div id="content">
          ...
          ?>
            <form method="post" action="" enctype="multipart/form-data">
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="ID_Proyek" value="<?php echo $d['ID_Proyek']; ?>">
                </div>
              </div>
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label">Nama Proyek</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="Nama_Proyek" value="<?php echo $d['Nama_Proyek']; ?>">
                </div>
              </div>
              <div class="row mb-3">
                <label class="col-sm-2 col-form-label">Deskripsi Proyek</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="Deskripsi_Proyek" value="<?php echo $d['Deskripsi_Proyek']; ?>">
                </div>
              </div>
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
          ...
          if (!in_array($gambar, $tipe_diizinkan)) {
            ...
            $insert = mysqli_query($sambungin, "UPDATE proyek SET 
                                      
                                      Nama_Proyek='$Nama_Proyek',
                                      Deskripsi_Proyek='$Deskripsi_Proyek',
                                      gambar='$newname1' WHERE ID_Proyek='$ID_Proyek'");
            if ($insert) {
              echo '<script> alert("Berhasil memperbarui data") </script>';
              echo '<script>window.location="dataproyek.php" </script>';
            } else {
